    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto ">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" style="padding-inline: 10px;" href="/chains.php">Chains</a>
                </li>
                <li class="nav-item">
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="<?php echo $image?>" class="kaarts card-img-top" alt="KUT FIETS">
          <div class="card-body">
            <h2 class="card-title"><?php echo $title?></h2>
            <h3 class="card-text"><?php echo $bedrag; echo number_format($prijs, 2, ',', '.');?></h3>
            <h3 class="card-text orderfast ">
            <?php 
            if($vooraad >10){
              echo 'Snel bestellen, beperkte vooraad!';
            } else{
              echo '';
            }
            ?> 
      ...
      <div class="col">
        <div class="card h-100">
          <img src="<?php echo $image?>" class="kaarts card-img-top" alt="KUT SCHOENEN">
          <div class="card-body">
            <h2 class="card-title"><?php echo $title?></h2>
            <h3 class="card-text"> <?php echo $bedrag; echo number_format($prijs, 2, ',', '.');?></h3>
            <h3 class="card-text orderfast ">
      ...
      <div class="col">
        <div class="card h-100">
          <img src="<?php echo $image?>" class="kaarts card-img-top" alt="KUT AUTO">
          <div class="card-body">
            <h2 class="card-title"><?php echo $title?></h2>
            <h3 class="card-text"><?php echo $bedrag; echo number_format($prijs, 2, ',', '.');?></h3>
            <h3 class="card-text orderfast ">
